...
router.delete('/experience/:exp_id', auth, async (req, res) => {
  try {
    ...
    // Remove item from array of experience by remove index
...
router.delete('/education/:edu_id', auth, async (req, res) => {
  try {
    ...
    // Remove item from array of education by remove index
...
// @desc    Delete my user, profile & posts
// @access  Private
...
// @desc    Delete user, profile & posts by ID
// @access  Private
